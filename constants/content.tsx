...
const projects: ProjectsContent = {
  ...
  githubHref:   "https://github.com/cesarevc?tab=repositories",
  ...
  contacts: [
    {
      field: "email",
      label: "Email",
      value: "cesarevc.dev@outlook.com",
      href:  "mailto:cesarevc.dev@outlook.com",
      icon: (
    ...
    },
    {
      field: "github",
      label: "GitHub",
      value: "github.com/cesarevc",
      href:  "https://github.com/cesarevc",
      icon: (
    ...
    },
    {
      field: "linkedin",
      label: "LinkedIn",
      value: "linkedin.com/in/cesarevc",
      href:  "https://linkedin.com/in/cesarevc",
      icon: (
        <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
...
const footer: FooterContent = {
  logo:      { name: "cesarevc", domain: ".dev", initial: "C" },
  tagline:   "codeado con pasión y dedicación",
  copyright: "© 2026 Cesarevc. Todos los derechos reservados.",
  navItems: [
